...
import 'package:flutter/material.dart';
import 'dart:ui';
import 'package:flutterapp01/hotel_booking/calendar_popup_view.dart';
import 'package:flutterapp01/hotel_booking/hotel_list_view.dart';
import 'package:flutterapp01/hotel_booking/model/hotel_list_data.dart';
import 'package:flutter/material.dart';
...
class _HomeScreenState extends State<HomeScreen> with TickerProviderStateMixin {
  ...
  FilterRequestDto filterRequestDto = FilterRequestDto();
  ...
  void initState() {
    ...
    //fetching model List
    this.filterRequestDto.companyId = 1;
    this.filterRequestDto.oto = false;
    BlocProvider.of<ModelListBloc>(context)
        .add(FetchModelList(filterRequestDto: this.filterRequestDto));
    super.initState();
  }
                            ...
                            return Container(
                              ...
                              child: ListView.builder(
                                ...
                                itemBuilder: (BuildContext context, int index) {
                                  final int count = state.modelList.length > 10
                                      ? 10
                                      : state.modelList.length;
                                  ...
                                  return ModelListView(
                                    callback: () {},
                                    modelObject: state.modelList[index],
                                    animation: animation,
                                    animationController: animationController,
                                  );
                                },
